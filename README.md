...
3. **Data:** data sets may be downloaded from Kaggle using the links https://www.kaggle.com/datasets/clmentbisaillon/fake-and-real-news-dataset and https://www.kaggle.com/datasets/aadyasingh55/fake-news-classification/code.
